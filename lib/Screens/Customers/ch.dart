...
class HomePagech extends StatefulWidget {
  @override
  HomePagechState createState() => new HomePagechState();
}

class HomePagechState extends State<HomePagech> {
        ...
        body:  ListView(
          children: <Widget>[
             Container(
              ...
              child:  FlutterLogo(size: 100.0,textColor: Colors.green),
            ),
             Container(
